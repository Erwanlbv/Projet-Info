...
public class Training2 {
	...
	*/
	...
	Cette méthode enregistre ensuite le modèle obtenu pour pouvoir l'utiliser plus tard 
	...
	public void train() throws IOException, TranslateException {
		...
		// Si on le laisse en UNIFORM (XavierInitializer.RandomType.UNIFORM) on peut également 
		//initialiser les poids sur un schéma gaussien (XavierInitializer.RandomType.GAUSSIAN)
		...
		// Initialisation de la fonction de perte. SoftMaxCrossEntropy est une fonction de perte classique
		Loss loss = Loss.softmaxCrossEntropyLoss();
		...
		// Cette méthode d'optimisation est basée sur le travail de Diederik P. Kingma dans "Adam: A Method for Stochastic Optimization"
		// établi avec le Tracker défini précédemment 
		...
		//Un Training listeners permet d'obtenir des informations en temps direct et à la fin de l'entrainement
		//Un modèle classique de TrainingListener contient : - Un EpochTrainingListener
		//													 - Un EvaluatorTrainingListener (valeur de l'Accuraccy, SoftMax..
		//													 - Un DivergenceCheckTrainingListener (averti en cas de problème de divergence)
	...
	public SequentialBlock getModel() {
		...
		// Ajout d'une couche convolutive 7x7 avec 64 canaux de sortie et un stride de 2
		        ...
		        .add(BatchNorm.builder().build()) //On utilise la fonction d'activation relu.
		        .add(Activation::relu)
